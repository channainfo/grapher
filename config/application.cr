...
Amber::Server.configure do |settings|
  ...
  #
  # settings.name = "Grapher web application."
  #
  #
  ...
  #
  # settings.secret_key_base= WIoH8fihlZNiljP9-ovGj7d5f8zVEGszVlvKKHAMkb8
  #
  #
  ...
  #
  # settings.logger = Amber::Environment::Logger.new(File.open("grapher.log", "w"))
  #
  #
end
